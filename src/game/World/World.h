...
enum eConfigUInt32Values
{
    ...
    CONFIG_UINT32_CREATURE_RESPAWN_NORMAL_MIN_SECS,
    CONFIG_UINT32_CREATURE_RESPAWN_NORMAL_MAX_SECS,
    CONFIG_UINT32_WORLD_MAX_UPSCALE,
    CONFIG_UINT32_WORLD_MAX_DOWNSCALE,
    CONFIG_UINT32_QUEST_MAX_UPSCALE,
    CONFIG_UINT32_QUEST_MAX_DOWNSCALE,
...
enum eConfigFloatValues
{
    ...
    CONFIG_FLOAT_RATE_CREATURE_NORMAL_RESPAWN,
    CONFIG_FLOAT_RATE_CREATURE_ELITE_ELITE_RESPAWN,
    CONFIG_FLOAT_RATE_CREATURE_ELITE_RAREELITE_RESPAWN,
    CONFIG_FLOAT_RATE_CREATURE_ELITE_WORLDBOSS_RESPAWN,
    CONFIG_FLOAT_RATE_CREATURE_ELITE_RARE_RESPAWN,
